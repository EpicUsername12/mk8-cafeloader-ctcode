...
EXPORT_DECL(s32 *, WiiU__gh_errno_ptr, void);
...
void InitOSFunctionPointers(void) {
    ...
    OS_FIND_EXPORT(coreinit_handle, WiiU__gh_errno_ptr);

    OSDynLoad_FindExport(coreinit_handle, 0, "_Exit", &__Exit);
    OSDynLoad_FindExport(coreinit_handle, 0, "__gh_errno_ptr", &WiiU__gh_errno_ptr);
